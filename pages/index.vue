  ...
  <div>
    ...
    <div class="flex-grow overflow-scroll">
      <div class="flex flex-col">
        <div
          class="flex flex-col w-full pt-6 mx-auto transition-all duration-300 bg-white lg:flex-row sm:bg-gray-50 dark:bg-gray-800 pb-22 sm:pb-12 max-w-screen-2xl"
        >
          <div
            class="w-full p-4 mb-8 text-white bg-indigo-500 border-8 border-indigo-300 lg:shadow-2xl lg:ml-4 lg:w-1/3 dark:text-gray-200 dark:border-gray-700 dark:bg-gray-900 rounded-2xl xl:w-1/4"
          >
            ...
            - uhhh
            <br />
            - i think i like this layout, but i might make it more like door
            dash, like instead of entrees - sides ++ i'll do like sandwiches ->
            view all pizza -> view all smoothies -> view all etc
            <br />
            - ^ so in order to do that, i need to have a menu fully fleshed out
            <br />
            - make buttons more consistent?
            <br />
            - i need some way to display locations? or have some feed back based
            on locations
          </div>
          <div class="w-full max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <div v-for="section in sections" :key="section.name">
              ...
              <ul
                class="grid grid-cols-2 gap-4 mt-4 sm:grid-cols-3 md:grid-cols-4"
              >
                <li
